...
# Step 7.5: Run database seeder
echo "🌱 Running database seeder..."
php artisan db:seed --force || true

# Step 7.6: Assign super admin role
echo "🛡️ Assigning super admin role..."
php artisan shield:super-admin --user=1 || true

# Step 8: Run shield generate (skip migrate:fresh)
echo "🛡️ Running shield generate..."
